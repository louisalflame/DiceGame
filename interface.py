...
class MainFrame ( wx.Frame ):
	...
	def initCenterSizer(self):
		...
		self.DiceInfoPanel = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 250,50 ), wx.TAB_TRAVERSAL )
		...
		self.DicePlayPanel = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 250,80 ), wx.TAB_TRAVERSAL )
