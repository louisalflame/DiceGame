...
class MainFrame ( wx.Frame ):
	...
	def initDicePlay(self):		
		self.DicePlayPanel = wx.Panel( self, wx.ID_ANY, wx.DefaultPosition, wx.Size( 500,30 ), wx.TAB_TRAVERSAL )
		self.DicePlayPanel.SetMinSize( wx.Size( 500,30 ) )
		
		self.DicePlaySizer = wx.BoxSizer( wx.HORIZONTAL )		
		self.DicePlayPanel.SetSizer( self.DicePlaySizer )
		self.DicePlayPanel.Layout()

		self.MainSizer.Add( self.DicePlayPanel, 0, wx.ALL, 5 )
